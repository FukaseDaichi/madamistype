...
export const SURVEY_TRENDS_CONTENT = {
  surveyPeriod: {
    releaseDateLabel: "2026年4月4日",
    startDateLabel: "2026年4月4日",
    endDateLabel: "2026年4月11日",
    rangeLabel: "2026年4月4日〜2026年4月11日",
  },
  responseCount: 206,
  hero: {
    eyebrow: "Survey Report",
    title: "アンケートから見えた\nマダミス傾向ファイル",
    lead: "このページは、診断を2026年4月4日にリリースした直後、2026年4月4日から2026年4月11日までの一週間限定で集めた206件のアンケート回答をもとに、どのタイプの人が多かったのか、どんな作品がよく薦められていたのかを静的な記事としてまとめたものです。",
    caution:
