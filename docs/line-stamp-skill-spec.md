...
本書は、`madamistype-character-images` を土台として、LINE スタンプ用画像を生成する新規スキル群の設計案を定義する文書である。  
...
### 4.1 `madamistype-line-stamp-prompts`
...
### 4.2 `madamistype-line-stamp-images`
...
`madamistype-character-images` との関係は次の通りとする。
...
```json
{
  "setId": "ofei-daily-replies",
  "typeCode": "OFEI",
  "packageName": "OFEI daily replies",
  "locale": "ja",
...
{
  "schemaVersion": "v1",
  "skill": "madamistype-line-stamp-prompts",
  "setId": "ofei-daily-replies",
  "typeCode": "OFEI",
  "style": "character-only",
  "referencePolicy": {
...
- `skills/madamistype-character-images/scripts/nanobanana_client.py`
- `skills/madamistype-character-images/scripts/background_remover.py`
